...
class Producto:
    ...
    def total_producto(self):
        costos_adicionales = self.aplicar_costos_adicionales()
        print(f"Costos adicionales del producto {self.nombre}: {costos_adicionales}")
        self.total_producto = (self.precio - self.descuento) + costos_adicionales
